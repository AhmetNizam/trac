...
<html xmlns="http://www.w3.org/2001/XMLSchema">
	<head>
		...
		<title>Ulaşım ve Konaklama - Talep Onay Formu</title>
					...
					<form id="form1" method="post" enctype="multipart/form-data" action="">
						...
						<div align="center" style="height: 116px;">
							<div style="height: 103px; border: solid 1px red; border-radius: 2px; background-color: seashell;">
								...
								<div style="height: 17px;">Ulaşım ve Konaklama Talebini onaylıyor musunuz?</div>
								<div style="height: 43px;"></div>
							</div>
						</div>
						<div align="right">
							<div style="display: flex; width: 195px;">
								...
								<div>
									<input type="button" id="btn_ok" class="btn" value="Tamam ✔" onClick="approve($(this));" />
								</div>
							</div>
						</div>
					</form>		
