		...
		<script type="text/javascript">
			...
			function load_page(item, iframe, url) {
				...
				if(iframe != '' && url != '') {
					...
					if(item.attr('id') != 'btn_reservation')  {
	...
	<body>
		...
		<div style="width: 100%; height: 100%; display: flex;">
			<div style="width: 20%; height: 100%; border-right: solid 1px blue;">
				...
				<div style="width: 100%; display: flex;">
					<div style="width: 10%;"></div>
					<div style="width: 80%;"><input type="button" class="btn_blue" style="width: 100%;" value="Rezervasyonlarım" onClick="load_page($(this), 'iframe_page3', './request_list.php?list_type=1');" /></div>
				...
				<div style="height: 10px;"></div>
<?php		if($_SESSION['authorized_person']) { ?>
				<div style="height: 10px;"></div>
				<div style="width: 100%; display: flex;">
					<div style="width: 10%;"></div>
					<div style="width: 80%;"><input type="button" class="btn_green" style="width: 100%;" value="Bekleyen Talepler" onClick="load_page($(this), 'iframe_page4', './request_list.php?list_type=2&status=1');" /></div>
					<div id="div_menu_arrow4" class="menu_arrow_pasive" style="width: 10%;">⮞</div>
				</div>
				<div style="height: 10px;"></div>
				<div style="width: 100%; display: flex;">
					<div style="width: 10%;"></div>
					<div style="width: 80%;"><input type="button" class="btn_green" style="width: 100%;" value="Bekleyen Rezervasyonlar" onClick="load_page($(this), 'iframe_page5', './request_list.php?list_type=2&status=2');" /></div>
					<div id="div_menu_arrow5" class="menu_arrow_pasive" style="width: 10%;">⮞</div>
				</div>
				<div style="height: 10px;"></div>
				<div style="width: 100%; display: flex;">
					<div style="width: 10%;"></div>
					<div style="width: 80%;"><input type="button" class="btn_green" style="width: 100%;" value="Talepler" onClick="load_page($(this), 'iframe_page6', './request_list.php?list_type=2');" /></div>
					<div id="div_menu_arrow6" class="menu_arrow_pasive" style="width: 10%;">⮞</div>
				</div>
				<div style="height: 10px;"></div>
				<div style="width: 100%; display: flex;">
					<div style="width: 10%;"></div>
					<div style="width: 80%;"><input type="button" class="btn_green" style="width: 100%;" value="Rezervasyonlar" onClick="load_page($(this), 'iframe_page7', './request_list.php?list_type=2');" /></div>
...
<?php		} ?>
				...
				<div style="width: 100%; display: flex;">
					<div style="width: 10%;"></div>
					<div style="width: 80%"><input type="button" class="btn_red" style="width: 100%;" value="Çıkış" onClick="load_page($(this), 'iframe_page8', './login.php');" /></div>
					<div id="div_menu_arrow8" class="menu_arrow_pasive" style="width: 10%;">⮞</div>
				</div>
			</div>
			<div id="div_frame" class="menu_frame">
				<iframe id="iframe_page" ahm="niz" src=""></iframe>
			</div>
