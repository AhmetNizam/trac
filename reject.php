...
<html xmlns="http://www.w3.org/2001/XMLSchema">
	<head>
		...
		<title>Ulaşım ve Konaklama - Talep İptal Formu</title>
				...
				<div id="div_form_page" align="center">
					<form id="form1" method="post" enctype="multipart/form-data" action="">
						...
						<div align="left" style="height: 116px;">
							...
							<div><textarea id="txt_explanation" name="txt_explanation" label="div_lbl" area="area5" action="go" class="inp" style="height: 88px;" placeholder="Red nedenini yazınız"></textarea></div>
						</div>
						<div align="right">
							<div style="display: flex; width: 195px;">
								...
								<div>
									<input type="button" id="btn_ok" area="area5" action="warn" class="btn" value="Tamam ✔" onClick="reject($(this));" />
								</div>
							</div>
						</div>
					</form>		
