            ...
            <div id="div_transportation">
                ...
                <div style="display: flex;">
                    <div align="center" style="width: 49%;">
                        <div align="left" class="lbl_norm2" style="height: 17px; padding-left: 5px; padding-top: 2px; border: solid 1px green; background-color: #08E378; color: white;">Gidiş</div>
                    </div>
                    <div style="width: 2%;"></div>
                    <div align="center" style="width: 49%;">
                        <div align="left" class="lbl_norm2" style="height: 17px; padding-left: 5px; padding-top: 2px; border: solid 1px red; background-color: #F88284; color: white;">Dönüş</div>
                    </div>
                </div>
                <div style="display: flex;">
                    <div align="center" style="width: 49%;">
...
<?php	if($reservation['ACCOMMODATION']) { ?>
            <div id="div_accommodation">
                ...
                <div style="height: 10px;"></div>
                <div align="left" class="lbl_norm2" style="height: 17px; padding-left: 5px; padding-top: 2px; border: solid 1px blue; background-color: #657FF5; color: white;">Otel</div>
