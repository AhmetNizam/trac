<?php
	...
	if($conn) {
		$sql = ' SELECT R.ID, GET_ROUTE_NAME(R.ROUTE_ID) AS ROUTE, GET_REASON_NAME(R.REASON_ID) AS REASON,  
						GET_COUNTRY_NAME(R.FROM_COUNTRY_ID) AS FROM_COUNTRY, 
				 FROM REQUEST R
			...
			<form id="form1" name="form1" method="post" enctype="multipart/form-data" action="">
				<div align="center" class="style4" style="width: 900px; border: groove; background: url('./images/body.png');">
					<div style="width: 90%; font-size: 12px;">
												...
												<div align="left" style="width: 97%;">
													<div style="display: flex; height: 38px;">
														...
														<div style="width: 65%;">
															...
															<div><select id="sel_position" name="sel_position" label="div_lbl8" area="area1" action="go" class="style5" style="width: 100%; height: 30px;" onChange="set_selected_text('position');"></select></div>
														</div>
													</div>
													<div style="display: flex; height: 38px;">
														<div style="width: 35%;">
														...
														<div style="width: 65%;">
															...
															<div><select id="sel_department" name="sel_department" label="div_lbl9" area="area1" action="go" class="style5" style="width: 100%; height: 30px;" onChange="set_selected_text('department');"></select></div>
														</div>
													</div>
												</div>
											</div>
												...
												<div align="left" style="width: 97%;">
													<div style="display: flex; height: 38px;">
														...
														<div style="width: 65%;">
															...
															<div><select id="sel_location" name="sel_location" label="div_lbl10" area="area1" action="go" class="style5" style="width: 100%; height: 30px;" onChange="set_selected_text('location');"></select></div>
														</div>
													</div>
												</div>
											</div>
						...
						<div id="div_travel_info">
							<div style="display: flex;">
								<div align="left" style="width: 50%;">
									<div id="div_from_country" align="left" style="width: 97%; height: 58px;">
									...
									<div id="div_from_location" align="left" style="width: 97%; height: 58px;">
									...
									<div id="div_from_city" align="left" style="width: 97%; height: 58px;">
										...
										<div>
											...
											<div><select id="sel_from_city" name="sel_from_city" label="div_lbl13" area="area2" action="go" class="style5" style="width: 100%; height: 30px;" onChange="set_city('from_city');"></select></div>
										</div>
									</div>
								</div>
								<div align="right" style="width: 50%;">
									<div id="div_to_country" align="left" style="width: 97%; height: 58px;">
									...
									<div id="div_to_location" align="left" style="width: 97%; height: 58px;">
									...
									<div id="div_to_city" align="left" style="width: 97%; height: 58px;">
										...
										<div>
											...
											<div><select id="sel_to_city" name="sel_to_city" label="div_lbl16" area="area2" action="go" class="style5" style="width: 100%; height: 30px;" onChange="set_city('to_city');"></select></div>
										</div>
									</div>
								</div>
							</div>
							<div style="display: flex;">
								<div align="left" style="width: 50%;">
									<div id="div_travel_reason" align="left" style="width: 97%; height: 58px;">
						...
						<div style="height: 10px;"></div>
						<div id="div_transportation_accommodation" align="center" style="height: 25px;">
