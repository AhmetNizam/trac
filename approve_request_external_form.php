...
<body>
    <div id="div_main_area">
        <div id="div_main_frame" class="main_frame">
            ...
            <div class="heading">ULAŞIM ve KONAKLAMA TALEBİ ONAY FORMU</div>
            <div style="height: 40px;"></div>
                ...
                <form id="form1" method="post" enctype="multipart/form-data" action="">
                    ...
                    <div align="right">
                        <div style="display: flex; width: 195px;">
                            ...
                            <div>
                                <input type="button" id="btn_ok" requestid="<?php echo $requestid; ?>" class="btn" value="Tamam ✔" onClick="approve_request($(this));" />
                            </div>
                        </div>
                    </div>
                </form>		
